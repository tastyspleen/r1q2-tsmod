...
//		"[Rendition OpenGL]",
	...
	if (s_mode_list[SOFTWARE_MENU].curvalue > 20)
		s_mode_list[SOFTWARE_MENU].curvalue = 20;
	...
	if (s_mode_list[OPENGL_MENU].curvalue > 20)
		s_mode_list[OPENGL_MENU].curvalue = 20;
